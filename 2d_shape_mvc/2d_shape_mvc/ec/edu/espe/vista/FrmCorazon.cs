...
namespace _2d_shape_mvc.ec.edu.espe.vista
{
    public partial class FrmCorazon : Form
    {
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            var resultado = controlador.calcularCorazon(tamanio);
            dibujador = resultado.corazon.crearDibujador();
