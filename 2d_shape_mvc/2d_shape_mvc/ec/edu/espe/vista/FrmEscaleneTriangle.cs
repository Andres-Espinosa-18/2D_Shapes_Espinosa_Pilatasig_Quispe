...
namespace _2d_shape_mvc.ec.edu.espe.vista
{
    public partial class FrmEscaleneTriangle : Form
    {
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            if (!v.validarTrianguloEscaleno(l1, l2, l3))
            {
                lblMensaje.Text = "Los lados ingresados no formanun triangulo Escaleno válido. Revise sus datos";
                return;
            }
